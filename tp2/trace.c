...
//The output is a trace of the stack during the execution of each function.
//The two bottom lines are compiler traces for the initialization of the libs
//of the language. Then we have the lines corresponding to the trace
